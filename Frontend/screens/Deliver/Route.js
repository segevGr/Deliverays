...
const Route = ({ navigation, route }) => {
  ...
  const delete_delivery = (delivery_id) => {
    const updated_delivery_list = delivery_list.filter(
      (delivery) => delivery.letterNumber !== delivery_id
    );
    ...
    <View style={styles.container}>
      <View style={styles.title_style}>
        ...
        <Text style={styles.title_text}>
          יש לך {delivery_list.length} משלוחים להשלים
        </Text>
      </View>
        ...
        <View style={styles.content}>
          {delivery_list.map((item) => (
            ...
            >
              <TouchableOpacity
                onPress={() =>
                  cancel_alert(item.letterNumber, item.deliveryAddress)
                }
              >
                <Image
              ...
              <TouchableOpacity
                onPress={() =>
                  accept_alert(item.letterNumber, item.deliveryAddress)
                }
              >
                <Image
                  source={require("../../assets/accept_icon.png")}
                  style={styles.accept_btn}
                />
              </TouchableOpacity>
              <Text style={styles.delivery_name_label}>
