    ...
    <View style={styles.container}>
      ...
      <View style={styles.title_style}>
        ...
        <Text style={styles.title_text}>
          יש לך {delivery_list.length} משלוחים ברשימה
        </Text>
      </View>
          ...
          {delivery_list.map((letter) => {
            ...
            return (
              ...
              >
                <TouchableOpacity
                  onPress={() =>
                    delete_alert(letter.letterNumber, letter.deliveryAddress)
                  }
                >
                  <Image
                ...
                <TouchableOpacity
                  onPress={() => edit_delivery(letter.letterNumber)}
                >
                  <Image
                ...
                <Text style={styles.item_name_label}>
      ...
      <TouchableOpacity style={styles.add_item_btn} onPress={add_delivery}>
        <Text style={styles.add_user_label}>הוספת משלוח</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.filter_btn} onPress={showFilterDialog}>
